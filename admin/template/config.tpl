...
<p>
{'Check the predefined filters you want to enable.'|translate}<br />
{'Here you can set two filters to grab pictures list on your server, using Linux <em>find</em> command:'|translate} <strong style="white-space: pre; font-family: monospace;">find -L /path/to/galleries -type f -mmin 60</strong>.<br />
...
<fieldset>
	<legend><label><input type="checkbox" name="FSRMPPLUGIN_VAR_ENABLED_FILTERS[]" value="f1" {if in_array('f1', $fsrmp.enabled_filters)}checked="checked"{/if} /> {'First filter'|translate}</label></legend>
...
<fieldset>
	<legend><label><input type="checkbox" name="FSRMPPLUGIN_VAR_ENABLED_FILTERS[]" value="f2" {if in_array('f2', $fsrmp.enabled_filters)}checked="checked"{/if} /> {'Second filter'|translate}</label></legend>
    <label>{'Since'|translate}
...
<fieldset>
	<legend><label><input type="checkbox" name="FSRMPPLUGIN_VAR_ENABLED_FILTERS[]" value="f3" {if in_array('f3', $fsrmp.enabled_filters)}checked="checked"{/if} /> {'Third filter'|translate}</label></legend>
